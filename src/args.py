...
def add_train_args(parser):
    """train.py"""
    parser.add_argument(
        "--NET_G_path", type=str, default="", help="Generator model loading path"
    )
    parser.add_argument(
        "--NET_D_path", type=str, default="", help="Discriminator model loading path"
    )
    parser.add_argument(
        "--STAGE1_G_path",
        type=str,
    ...
    parser.add_argument(
        "--TRAIN_LR_DECAY_EPOCH", type=int, default=20, help="train lr decay epoch"
    )
    parser.add_argument(
        "--TRAIN_MAX_EPOCH", type=int, default=120, help="train maximum epochs"
    )
    parser.add_argument(
        "--TRAIN_SNAPSHOT_INTERVAL", type=int, default=5, help="Snapshot interval"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--STAGE", type=int, default=2, help="Stage to train/eval (1/2)"
    )
    parser.add_argument(
        "--device",
        type=str,
...
def add_model_args(parser):
    ...
    for parameter names.
    """
    parser.add_argument("--n_g", type=int, default=128, help="")
    parser.add_argument("--n_z", type=int, default=100, help="")
    parser.add_argument("--m_d", type=int, default=4, help="")
...
def add_cub_file_args(parser):
    ...
    parser.add_argument(
        ...
        help="Text file path: mapping image id to image path",
    )  # <image_id> <image_name>
    parser.add_argument(
        "--train_test_split_file",
        type=str,
        default="../input/data/CUB_200_2011/train_test_split.txt",
        help="Text file path: mapping image id to train/test split",
    )  # <image_id> <is_training_image>
    parser.add_argument(
        "--bounding_boxes",
        type=str,
